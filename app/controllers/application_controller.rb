class ApplicationController < ActionController::Base
  ...
  def fetch_api_data
    ...
    @response = RestClient::Request.execute(
      ...
      url: "https://api.yelp.com/v3/businesses/search?term=#{query}&location=new+york&open_now=true&limit=50&price=#{cost[0]},#{cost[1]}&#{filter[0]},#{filter[1]},#{filter[2]}",
      ...
      @response = RestClient::Request.execute(
        ...
        url: "https://api.yelp.com/v3/businesses/search?term=#{query}&location=new+york&open_now=true&limit=50&price=#{cost[0]}&#{filter[0]},#{filter[1]},#{filter[2]}",
